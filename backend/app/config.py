...
class Settings(BaseSettings):
    ...
    # Пропорции экрана в зале, «ширина:высота». Сам холст подстраивается под окно,
    # а вот мини-полотно на терминале иначе не знает, какой формы стена, и врало бы
    # про раскладку. На выставке стоит книжная панель, отсюда 9:16.
