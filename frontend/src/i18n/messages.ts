...
export const MESSAGES: Record<UiLanguage, Messages> = {
  ru: {
    ...
    saved: "Сохранено ✓",
    display: "Отобразить на экране",
    displayed: "Отправлено на купол ✓",
    close: "Закрыть",
    gallery: "Галерея",
    ...
    ttlHint: "Хранится до {time}. Сохраните в галерею или отправьте на купол, чтобы не удалилось.",
  ...
  en: {
    ...
    ttlHint: "Kept until {time}. Save it to the gallery or send it to the dome to keep it for good.",
  ...
  zh: {
    ...
    detectedAs: "识别语言",
    degraded: "翻译失败，已使用原文",
    ttlHint: "保存至 {time}。保存到图库或发送到穹顶即可永久保留。",
  ...
  fr: {
    ...
    ttlHint: "Conservée jusqu'à {time}. Enregistrez-la dans la galerie ou envoyez-la au dôme pour la garder.",
  ...
  es: {
    ...
    ttlHint: "Se conserva hasta las {time}. Guárdala en la galería o envíala a la cúpula para conservarla.",
  ...
  pt: {
    ...
    displayed: "Enviado para a cúpula ✓",
    close: "Fechar",
    gallery: "Galeria",
    ...
    ttlHint: "Guardada até às {time}. Guarde na galeria ou envie para a cúpula para a manter.",
  ...
  ar: {
    ...
    save: "حفظ في المعرض",
    saved: "تم الحفظ ✓",
    display: "عرض على الشاشة",
    displayed: "أُرسلت إلى القبة ✓",
    close: "إغلاق",
    gallery: "المعرض",
    galleryTitle: "المعرض",
    ...
    ttlHint: "محفوظة حتى {time}. احفظها في المعرض أو أرسلها إلى القبة للاحتفاظ بها.",
...
/**
 * Язык интерфейса. По умолчанию русский: язык браузера здесь не спрашиваем, иначе
 * у гостя с английской локалью весь интерфейс молча уезжал в английский.
 * Явный выбор в форме по-прежнему переключает и подписи — ради гостей с других языков.
 */
