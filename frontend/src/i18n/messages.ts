...
export const MESSAGES: Record<UiLanguage, Messages> = {
  ru: {
    ...
    codeSubtitle: "Введите почту, по которой регистрировались",
    codeSubmit: "Войти",
    signingIn: "Проверяем…",
  ...
  en: {
    ...
    codeSubtitle: "Enter the email you registered with",
    codeSubmit: "Sign in",
    signingIn: "Checking…",
  ...
  fr: {
    ...
    codeSubtitle: "Saisissez l'e-mail utilisé lors de l'inscription",
  ...
  es: {
    ...
    codeSubtitle: "Introduce el correo con el que te registraste",
    codeSubmit: "Entrar",
  ...
  pt: {
    ...
    codeSubtitle: "Introduza o e-mail com que se registou",
    codeSubmit: "Entrar",
  ...
  ar: {
    ...
    codeSubtitle: "أدخل البريد الإلكتروني الذي سجّلت به",
    codeSubmit: "دخول",
